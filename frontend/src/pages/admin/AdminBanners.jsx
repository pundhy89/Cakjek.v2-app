...
const empty = { title: "", subtitle: "", description: "", link: "", code: "", color_from: "#fb923c", color_to: "#ec4899", image: "", order_idx: 0, active: true, start_date: "", end_date: "" };
          ...
          <div onClick={(e) => e.stopPropagation()} className="bg-card rounded-3xl w-full max-w-md p-6 shadow-2xl">
            ...
            <div className="space-y-3">
              ...
              <label className="block">
                <span className="text-xs font-medium text-muted-foreground">Deskripsi (tampil di halaman Promo)</span>
                <textarea data-testid="bf-desc" rows={3} value={form.description} onChange={(e) => setForm({ ...form, description: e.target.value })} className="mt-1 w-full bg-secondary rounded-xl px-3 py-2 text-sm outline-none resize-y" />
              </label>
              <F label="Link Tujuan (opsional, mis. https://...)" v={form.link} on={(v) => setForm({ ...form, link: v })} testid="bf-link" />
