...
**Endpoint:** `GET https://app-cdlq64jscrup-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-cdlq64jscrup-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,
